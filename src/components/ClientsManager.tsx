...
import { PlusIcon, UsersIcon, ChevronRightIcon } from '@/components/icons'
import {
  getSupabaseClient,
  type Client,
  type Property
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 md:text-3xl">Clients</h1>
          <p className="mt-1 text-sm text-gray-600">Manage clients and their property addresses.</p>
        </div>
        <button
          type="button"
      ...
      {hasClients ? (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="truncate text-sm text-gray-500">
                  {client.properties.length} {client.properties.length === 1 ? 'address' : 'addresses'}
        ...
        <div className="rounded-2xl border border-dashed border-gray-300 bg-white p-10 text-center">
          ...
          <p className="mt-1 text-sm text-gray-600">Add your first client to start tracking their addresses.</p>
          <button
            type="button"
            onClick={handleOpenModal}
          ...
          >
            <PlusIcon className="h-4 w-4" /> Add your first client
          </button>
        </div>
      )}
